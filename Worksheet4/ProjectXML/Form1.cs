...
namespace ProjectXML
{
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (title != "<Selected book title>")
            {
                handler.AddRateToBook(title, rate);
                MessageBox.Show("Rate added to book!");
            }
            else
            {
                MessageBox.Show("No book title selected!");
            }
        }
        ...
        private void buttonEx10_Click(object sender, EventArgs e)
        {
            ...
            if (isbn == "" || title != "<Selected book title>")
            {
                handler.AddAttributeISBNToBook(title, isbn);
                MessageBox.Show("ISBN added to book!");
            }
            else
            {
                MessageBox.Show("No book title selected or ISBN is empty!");
            }
        }
    }
}
